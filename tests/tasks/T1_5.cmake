...
# The CPU reference inside the .cu file uses OpenMP; nvcc's host pass needs the
# flag explicitly (OpenMP::OpenMP_CXX only adds it for CXX sources).
...
if(TARGET test_tightness_gpu)
  kiss_cuda_openmp(test_tightness_gpu)
endif()
