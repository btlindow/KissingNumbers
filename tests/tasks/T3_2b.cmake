...
# launch is parallel with OpenMP (nvcc host pass needs -fopenmp).
kiss_add_test(NAME test_ls_search SOURCES test_ls_search.cu GPU LIBS kiss_cuda TIMEOUT 2400)
if(TARGET test_ls_search)
  target_compile_options(test_ls_search PRIVATE
    $<$<COMPILE_LANGUAGE:CUDA>:-Xcompiler=-fopenmp>)
  target_link_options(test_ls_search PRIVATE -fopenmp)
endif()
